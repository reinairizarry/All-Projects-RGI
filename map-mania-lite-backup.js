...
var favoritePlaces = [
    {content:'<strong>#1: Crooked Forest, Poland>', coordinates:{lat:41.837546,lng:-14.475}, iconImagePath:"one.png"},
    {content:'Witch House, Salem', coordinates:{lat:36.3932,lng:25.4615}, iconImagePath:"flag.png"},
...
function initMap() {
    ...
    var marker = new google.maps.Marker({position:{lat:53.213889,lng:14.475}, map:gMap});

    // Add a second marking with a custom icon, an Info window, and a listener.
    var marker2 = new google.maps.Marker({position:{lat:53.213889,lng:14.475}, map:gMap});
...
function updateGame() {
    ...
    // Check if Crooked Forest, WI is in the currently displayed map
